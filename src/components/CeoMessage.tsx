    ...
    >
      <Container>
        ...
        <div className="grid grid-cols-12 gap-8 lg:gap-16 xl:gap-24">
          <div className="relative mt-12 mx-auto grid max-w-2xl lg:max-w-none pt-6 col-span-6">
            <p className="text-gray-200">
              ...
              수작업으로 이것을 분석하시는데 많은 시간과 노력이 듭니다. <br />
              ...
              투명 교정 장치 제작용으로 활용할 수 있습니다. 또한, 양악 수술을 위한 3차원 영상의 자동 SIMULATION 및 수술용 가이드를 제공할 예정입니다.<br />
              ...
              모쪼록 선생님들의 가정에 늘 행운이 함께 하시고 가족 모두 건강하시기를 기원드립니다.<br />
              Thank you
            </p>
          </div>
