...
export default function about() {
  ...
  return (
    <section
    id="about"
    className="mx-4 grid max-w-mx grid-cols-1 items-start gap-x-8 gap-y-10 px-4 py-24 sm:px-6 sm:py-32  lg:grid-cols-4 lg:max-w-full"
  >
  ...
  <div className="grid lg:grid-cols-1 gap-y-2 sm:grid-cols-1 sm:gap-y-40 lg:gap-x-4">
        ...
        <div className="overscroll-y-contain overflow-auto aspect-w-2 p-6  lg:col-span-3">
